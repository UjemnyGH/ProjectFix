#pragma once
#ifndef __BITMAP_IMAGES_
#define __BITMAP_IMAGES_
...
std::vector<uint8_t> LoadBitmapFromFile(std::string filename, uint32_t* w, uint32_t* h, bool recieveSizes = true) {
    ...
    *h = 0;
    ...
    ENG_INFO("Opened image file: " << filename);
    ...
    ENG_DEBUG("Header size: " << headerSize);
    ...
    ENG_DEBUG("Width: " << *width << " Height: " << *height);
    ...
    ENG_DEBUG("Pixels loaded to " << static_cast<void*>(result.data()))
